...
<body class="img" style="background-image: url(assets/img/hero.jpg);background-size: 1920px 960px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            ...
                                            <a class="btn btn-secondary" href="login.php">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small">
                                        &copy; Muh Nur Rasyid UKK
                                    </div>
                                </div>
                            </div>
                        </div>
